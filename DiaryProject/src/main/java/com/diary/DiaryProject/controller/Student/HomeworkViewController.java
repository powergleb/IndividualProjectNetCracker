...
//    public  ResponseEntity<Resource> downloadFilesForHomework(Model model, @PathVariable("id") Integer id) {
//        Homework homework = homeworkService.readHomework(id);
//        List<FileInfo> files = homework.getFileInfoList();
//
//            try {
//                //for (FileInfo foundFile : files) {
